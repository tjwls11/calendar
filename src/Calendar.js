...
function Calendar() {
  ...
  const [isEditingYearInYearlyView, setIsEditingYearInYearlyView] =
    useState(false) // 연간 보기 모드에서 연도 편집 모드 여부
    ...
    return (
      <div className="year-view">
        <div className="year-header">
          <button onClick={prevYear} className="prev-button">
            ◀
          </button>
          {isEditingYearInYearlyView ? (
            ...
            <span
              ...
              onClick={() => setIsEditingYearInYearlyView(true)}
            >
              {format(currentYear, 'yyyy년')}
            </span>
          )}
          <button onClick={nextYear} className="next-button">
            ▶
          </button>
        </div>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        {isSidebarOpen && (
          <div className="sidebar-content">
            ...
            <button className="sidebar-button" onClick={handleYearlyViewClick}>
              연간 달력 보기
            </button>
            <button className="sidebar-button" onClick={handleCurrentViewClick}>
              월별 달력 보기
            </button>
            <span className="material-symbols-outlined" onClick={goToToday}>
              refresh
            </span>
          </div>
        )}
